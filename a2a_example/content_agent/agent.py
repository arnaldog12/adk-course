...
The analysis supports a positive outlook with manageable risks and significant opportunities for success.
            ...
            "metadata": {"format": "executive_summary", "audience": "decision_makers", "tone": "professional"},
        }
...
Stakeholders who position themselves strategically will be well-placed to benefit from future developments.
            ...
            "metadata": {"format": "feature_article", "audience": "general_professional", "tone": "informative"},
        }
...
{topic} presents a compelling opportunity with clear pathways for successful implementation and growth.
            ...
            "metadata": {"format": "technical_report", "audience": "technical_professionals", "tone": "analytical"},
        }
    else:
        return {
            "status": "success",
...
and practical implications for stakeholders.
            ...
            "metadata": {"format": "general", "audience": "general", "tone": "neutral"},
        }
